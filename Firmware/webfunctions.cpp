...
void send_left_display( void ){
    uint8_t imagedata[574] = {0x42 ,0x4D ,0x3E ,0x02 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x3E ,0x00 ,0x00 ,0x00 ,0x28 ,0x00,
...
/* Problem is how to send this data to the client as we have no function that takes binary from RAM */                         
